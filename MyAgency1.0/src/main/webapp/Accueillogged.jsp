...
<link rel="stylesheet" href="Accueillogged.css" media="screen">
    ...
    <meta property="og:title" content="Accueillogged">
    ...
    <meta name="twitter:title" content="Accueillogged">
  ...
  <header class="u-clearfix u-header" id="sec-f174" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-clearfix u-image u-section-1" id="carousel_5e03" data-image-width="1366" data-image-height="768">
      <div class="u-clearfix u-sheet u-sheet-1">
      
        <h3 class="u-align-center u-custom-font u-font-montserrat u-text u-text-body-alt-color u-text-1">Nos clients sont notre première priorité</h3>
        <h1 class="u-align-center u-custom-font u-font-open-sans u-text u-text-palette-3-base u-title u-text-2">Bienvenue ${username}</h1>
        ...
        <p class="u-align-center u-text u-text-body-alt-color u-text-3">Ne cherchez plus loin! Nous vous proposons un vaste choix de véhicules de toutes les classes. Ainsi, vous trouverez à coup sûr celui qu'il vous faut!</p>
        <a href="#" class="u-align-center u-btn u-button-style u-hover-white u-palette-2-base u-btn-1">Ensuite</a>
      </div>
    </section>
